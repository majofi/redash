...
FEATURE_SHOW_PERMISSIONS_CONTROL = parse_boolean(os.environ.get("REDASH_FEATURE_SHOW_PERMISSIONS_CONTROL", "true"))
FEATURE_ENABLE_VIEW_PERMISSION = parse_boolean(os.environ.get("REDASH_FEATURE_ENABLE_VIEW_PERMISSION", "true"))
FEATURE_ALLOW_CUSTOM_JS_VISUALIZATIONS = parse_boolean(os.environ.get("REDASH_FEATURE_ALLOW_CUSTOM_JS_VISUALIZATIONS", "true"))
